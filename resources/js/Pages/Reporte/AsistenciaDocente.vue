<script setup>
    ...
    const {
        registros, errors, obtenerMarcacionesMensualDocente
    } = useMarcacion();
    ...
    const cargar=async()=>{
        dato.value.errors = []
        await obtenerMarcacionesMensualDocente(dato.value)
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-1">
                        ...
                        <JsonExcel v-if="LoadState" class="btn btn-success" :fields="jsonFields" :data="registros.docentes">
                    ...
                    <div class="col-md-12 mb-1 small">
                        <div class="table-responsive">         
                            <table class="table table-bordered table-hover table-sm table-striped">
                                ...
                                <tbody>
                                    <tr v-if="registros.docentes?.length == 0">
                                        <td class="text-danger text-center" colspan="12">
                                            -- Datos No Registrados - Tabla Vacía --
                                        </td>
                                    </tr>
                                    <tr v-else v-for="(marcacion,index) in registros.docentes" :key="marcacion.id">
                                        <td>{{ index+1 }}</td>

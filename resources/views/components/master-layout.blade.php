...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Asistencia Ugel Ambo</title>
    ...
    <link src="falcon316/fontawesome/css/all.css"></link>
    ...
    <link href="miestilo.css" rel="stylesheet" id="user-style-default">
    <style type="text/css">
    .loader {
      width: 48px;
      height: 48px;
    ...
    <script src="falcon316/fontawesome/js/all.min.js"></script>
